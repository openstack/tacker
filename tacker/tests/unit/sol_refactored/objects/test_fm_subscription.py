...
class TestFmSubscriptionObject(tests_base.BaseTestCase):
    ...
    def test_from_db_obj(self, mock_decrypt):
        ...
        obj = objects.FmSubscriptionV1.from_db_obj(fm_subsc)
        dict_of_auth = {}
    ...
    def test_to_db_obj(self, mock_encrypt):
        ...
        fm_subsc = objects.FmSubscriptionV1(
            # only set used members in the method
            callbackUri="testUri",
            authentication=auth)

        obj = fm_subsc.to_db_obj()
